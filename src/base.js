...
let Qbao = function (url, chainId) {
    this.url = url;
    this.chainId = chainId;
    this.path = "m/44'/521'/0'/0/0";
    this.bech32MainPrefix = "qbt";
...
Qbao.prototype.setBech32MainPrefix = function (bech32MainPrefix) {
...
Qbao.prototype.setPath = function (path) {
    this.path = path;
...
Qbao.prototype.getAccounts = function (address) {
    return fetch(this.url + "/auth/accounts/" + address)
        .then(response => response.json()
        )
}

Qbao.prototype.getAddress = function (mnemonic) {
...
Qbao.prototype.getECPairPriv = function (mnemonic) {
    if (typeof mnemonic !== "string") {
        throw new Error("mnemonic expects a string")
    }
    const seed = bip39.mnemonicToSeed(mnemonic);
...
Qbao.prototype.NewStdMsg = function (input) {
...
Qbao.prototype.sign = function (stdSignMsg, ecpairPriv, modeType = "sync") {
...
Qbao.prototype.broadcast = function (signedTx) {
